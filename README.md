# School
School is an isolated microservice that is a part of the Education Management System. Its role is to manage schools, levels, classes, subjects, add students to a class and assign a teacher to a subject.
## Getting Started
...
```bash
$ git clone https://github.com/JehonaK/school.git
```
...
- Maven 3 or later
- MySQL 8.0
Have a database named *school* created:
```python
